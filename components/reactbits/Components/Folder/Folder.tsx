  ...
  return (
    <div style={ scaleStyle } className={ className }>
      ...
      >
        <div
          className={ `
            rounded-tl-0 relative h-[80px] w-[100px] rounded-tr-[10px]
        ...
        >
          <span
            className={ `
              rounded-bl-0 rounded-br-0 absolute bottom-[98%] left-0 z-0
              h-[10px] w-[30px] rounded-tl-[5px] rounded-tr-[5px]
            ` }
            style={ { backgroundColor: folderBackColor } }
          ></span>
          { /* Render papers */ }
          { papers.map((item, i) => {
            ...
            const transformStyle =
              open ? `${getOpenTransform(i)} translate(${paperOffsets[i].x}px, ${paperOffsets[i].y}px)` : undefined;
            ...
            return (
              <div
                ...
                className={ `
                  absolute bottom-[10%] left-1/2 z-20 transition-all
                  duration-300 ease-in-out
                  ${
                  !open ? `
                    -translate-x-1/2 translate-y-[10%] transform
          ...
          <div
            className={ `
              absolute z-30 h-full w-full origin-bottom transition-all
              duration-300 ease-in-out
              ${
